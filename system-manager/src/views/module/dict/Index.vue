        ...
        <el-header class="header-box">
            <div class="left">
                <el-button type="primary" @click="add" icon="el-icon-circle-plus-outline"
                    v-if="$system.isAuth('sys:dict:add')">新增</el-button>
            </div>
            <div class="right">
                    ...
                    <template slot-scope="scope">
                        <el-button-group>
                            ...
                            <el-button @click="del(scope.$index, scope.row)"
                                ...
                                v-if="$system.isAuth('sys:dict:del') && !scope.row.hasChildren"/>
                        </el-button-group>
                    </template>
                </el-table-column>
            </el-table>
